    ...
    <div data-slot="hands-free-status-line" className={className}>
      ...
      {exchangeState === "speaking" && (
        <div className="flex items-center gap-2 text-sm py-1">
          <i className="ph-bold ph-speaker-high text-xs text-teal-400 animate-pulse" />
      ...
      {exchangeState === "sending" && (
        <div className="flex items-center gap-2 text-text-muted text-sm py-1">
          <i className="ph-bold ph-paper-plane text-xs text-teal-400" />
          <span>Sending...</span>
        </div>
      )}
      ...
      {exchangeState === "error" && (
        <div className="flex items-center gap-2 py-1">
          <i className="ph-bold ph-warning text-sm text-amber-400" />
