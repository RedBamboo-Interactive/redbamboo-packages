    ...
    <div className="flex flex-col h-full">
      <PanelHeader variant="compact">
        ...
        <div className="relative">
          <i className="ph-bold ph-magnifying-glass absolute left-2 top-1/2 -translate-y-1/2 text-[10px] text-text-muted" />
          <Input
        ...
        <div className="relative">
          <i className="ph-bold ph-user absolute left-2 top-1/2 -translate-y-1/2 text-[10px] text-text-muted" />
          <Input
            placeholder="Author..."
        ...
        <div className="ml-auto flex items-center gap-1 text-xs text-text-muted">
          ...
          >
            <i className="ph-bold ph-caret-left text-[10px]" />
          </Button>
          ...
          <Button
            ...
            onClick={() => onPageChange(page + 1)}
          >
            <i className="ph-bold ph-caret-right text-[10px]" />
          </Button>
        </div>
      </PanelHeader>
      ...
      <div className="flex-1 min-h-0 overflow-auto">
        {loading && commits.length === 0 ? (
          <div className="flex items-center justify-center py-12">
            <i className="ph-bold ph-spinner animate-spin text-text-muted" />
          </div>
        ) : (
