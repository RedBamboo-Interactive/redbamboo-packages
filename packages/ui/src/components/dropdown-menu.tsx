  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        ...
        inset && "pl-8",
        variant === "destructive" && "text-destructive focus:bg-destructive-a10 focus:text-destructive",
        className
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-widest text-muted-foreground [@media(hover:none)_and_(pointer:coarse)]:hidden",
        className,
      )}
      {...props}
    />
